<template>
  ...
  <el-form ref="form" :model="form" label-width="80px">
    ...
    <el-row :gutter="20">
      ...
      <el-button icon="el-icon-search" type="primary" @click="tableFn">查询</el-button>
    </el-row>
...
<el-table border :stripe="true" :data="tableList" style="width: 100%">
    ...
    <el-table-column align="right" fixed="right" width="200">
      <template slot="header" slot-scope="scope">
        <el-input v-model="keySearch" size="mini" placeholder="输入验证码搜索"/>
      </template>
    </el-table-column>
</el-table> -->
...
import { timerBaseFn } from "../../common/js/formatDateTime";
import "../../common/js/formatDateTime";
import {rechargeList} from "../../api/api.js";
export default {
    name:"rechargeList",
    data(){
        return {
    ...
    computed: {
      ...
      tableList() {
        return this.tableData.filter(item => {
          if (item.verifCode.includes(this.keySearch)) {
            return item;
          }
          this.currentPage = 1;
        });
